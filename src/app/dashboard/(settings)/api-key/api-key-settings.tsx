            ...
            <div>
              ...
              <div className="mt-1 relative">
                ...
                <div className="absolute space-x-0.5 inset-y-0 right-0 flex items-center">
                  <Button className="p-1 w-10 focus:outline-none focus:ring-2 focus:ring-brand-500" variant="ghost" onClick={copyApiKey}>
                    {copySuccess?(<CheckIcon className="size-4 text-brand-900"/>):(<ClipboardIcon className="size-4 text-brand-900"/>)}
                  </Button>
                </div>
              </div>
              <p className="mt-2 text-sm/6 text-gray-600">Keep your key secret and do not share it with others</p>
            </div>
        </Card>
    )
}