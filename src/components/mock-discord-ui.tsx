...
export const MockDiscordUI=({children}:{children:ReactNode})=>{
    return(
        <div className="flex min-h-[800px] w-full max-w-[1240px] bg-discord-background text-white rounded-lg overflow-hidden shadow-xl">
            <div className="hidden sm:flex w-[80px] bg-[#202225] py-3 flex-col items-center">
            ...
            <div className="hidden md:flex flex-col w-60 bg-[#2f3136]">
                <div className="px-4 h-16 border-b border-[#202225] flex items-center shadow-sm justify-center">
                <div className="w-full bg-[#202225] text-sm h-8 flex items-center justify-center rounded px-2 text-gray-500 cursor-not-allowed">
                ...
                <div className="flex-1 overflow-y-auto pt-4">
                    ...
                    <div className="px-2 mb-4">
                        <h3 className="text-xs font-semibold text-[#8e9297] px-2 mb-2 uppercase">Direct Message</h3>
                        <div className="flex items-center px-2 py-1.5 rounded bg-[#393c43] text-white cursor-pointer">
                            <Image src='/brand-asset-profile-picture.png' width={32} height={32} alt='PingPanda Avatar' className="object-cover rounded-full mr-3"/>
                            <span className="font-medium">TourPanda</span>
                        </div>
                    </div>
                ...
                <div className="p-2 bg-[#292b2f] flex items-center">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <Headphones className="size-5 text-[#020912] hover:text-white cursor-pointer"/>
            ...
            <div className="flex-1 flex flex-col">
              <div className="h-16 bg-[#36393f] flex items-center px-4 shadow-sm border-b border-[#202225]">
                ...
                <div className="flex items-center">
                  ...
                  <p className="font-semibold text-white">TourAI</p>
                </div>
              ...
              <div className="p-4">
                <div className="flex items-center bg-[#40444b] rounded-lg p-1">
                  ...
                  <input readOnly type='text' placeholder="Message @TourAI" className="flex-1 bg-transparent px-1 py-2.5 text-white placeholder-[#72767d] focus:outline-none cursor-not-allowed"/>
